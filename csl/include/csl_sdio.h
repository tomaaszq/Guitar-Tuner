...
#define CSL_SDIO_RESET_COUNT         (0x4u)
/** Time delay                                                               */
...
#define CSL_SDIO_CMD41_RESP         (0x80FFu)
/** SDIO response for SDHC card                                              */
#define CSL_SDIO_SDHC_RESP          (0x4000u)

/** SDIO time out error                                                      */
#define CSL_ESDIO_TIMEOUT           (0x101u)
/** Error code to indicate IO portion of the SDIO card is not ready          */
#define CSL_ESDIO_IO_NOTREADY       (0x102u)
/** Error code to indicate Memory portion of the SDIO card is not ready      */
#define CSL_ESDIO_MEM_NOTREADY      (0x103u)
 ...
 *
 *   @b Modifies
 *   @n SDIO Object will be assigned to NULL.
 *
 *   @b Example
 *   @verbatim
            CSL_SdioControllerObj    sdioContObj;
 ...
 *      with invalid RCA will put the card into suspend state.
 *
 *   @b Arguments
 *   @verbatim
            hSdio      Handle to the SDIO.
 ...
 *      sends given command to the card and wait for the response. Response
 *      success or timeout will be returned.
 *
 *   @b Arguments
 *   @verbatim
            hSdio          Handle to the SDIO.
 ...
 *
 *\n    Response type     Respose bits       Resp buf Fields populated
 *\n    ==============    ============       =========================
 ...
 *
 *   @b Description
 *   @n This function will enable the events in the MMC interrupt mask
 ...
 *   @verbatim
            ...
            pReadData      Pointer to read data
     @endverbatim
 *
 *   <b> Return Value </b>  CSL_Status
 *   @li                    CSL_SOK             - Close successful
 ...
 *
 *   @b Description
 *   @n This function writes a sign le byte of data to the SDIO card.
 ...
 *      that cab be read using this function are 512.
 *
