...
#define CSL_USB_ENDPOINT_COUNT                      (6)
...
#define CSL_USB_CLEAR_FEATURE                       (0x02)
...
/** \brief  USB Power Descriptor Type Value                                  */
...
#define CSL_USB_PER_RESTCOUNT                       (0x10)
...
/** USB Dma sheduler control register default value                          */
...
typedef enum {
	...
	/* FIFO data is accessed by the CPPI DMA Engine                          */
	CSL_USB_OPMODE_DMA
} CSL_UsbOpMode;
...
typedef struct CSL_UsbContext {
	...
	CSL_USB_APP_TRANSFER_CALLBACK    startTrasferCallback;
 ...
 *      and resetting it to '0'. Application needs to decide a delay such that
 ...
 *   @verbatim
            ...
            status = USB_selfwakeup(CSL_USB0, 1000000);
     @endverbatim
 *  ============================================================================
 */
 ...
 *
 *   @b Description
 *   @n Initializes PLL for USB operation
 *
 *   @b Arguments
 *   @verbatim
                   None
