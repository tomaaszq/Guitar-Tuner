...
#define CSL_MMCSD_PAGE_SIZE     (512)
...
/** @addtogroup CSL_MMCSD_FUNCTION
  ...
  *
  *   @b Description
  *   @n This function initializes the ATA state structure. Initializes all the
  *      function pointers in the ATA state structure with appropriate function
  *      address. This function should be called by the application program
  *      before transferring the control over the media to ATA file system.
  *
  *   @b Arguments
  *   @verbatim
