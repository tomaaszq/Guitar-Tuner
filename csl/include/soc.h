...
/** \brief EMIF CS2 address offset                                           */
#define CSL_EMIF_CS2_ADDR_OFFSET                    (0x1000u)
/** \brief EMIF CS2 command offset                                           */
#define CSL_EMIF_CS2_CMD_OFFSET                     (0x2000u)
/** \brief NAND CE0 address for DMA access                                   */
#define CSL_NAND_CE0_ADDR                           (0x2000000u)
/** \brief NAND CE1 address for DMA access                                   */
