...
#define CSL_MSC_REQUEST_BULK_ONLY_RESET			               (0x20FF)
...
/** Dummy descriptor length in bytes                                         */
#define CSL_MSC_DUMMY_DESC_DEFLEN                              (9)
/** Default value for element 0 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC0_DEFVAL                             (0x0000)
/** Default value for element 2 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC2_DEFVAL                             (32)
/** Default value for element 3 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC3_DEFVAL                             (0x0101)
/** Default value for element 4 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC4_DEFVAL                             (0xC004)
/** Default value for element 5 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC5_DEFVAL                             (0x0932)
/** Default value for element 6 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC6_DEFVAL  (CSL_MSC_INTERFACE_DESCRIPTOR_TYPE)
/** Default value for element 7 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC7_DEFVAL                             (0x0200)
/** Default value for element 8 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC8_DEFVAL  (0x0600 | CSL_MSC_DEVICE_CLASS_STORAGE)
/** Default value for element 9 in dummy descriptor array                    */
#define CSL_MSC_DUMMY_DESC9_DEFVAL                             (0x0550)
/** Default value for element 10 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC10_DEFVAL ((CSL_MSC_ENDPOINT_DESCRIPTOR_TYPE<<8) | 7)
/** Default value for element 11 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC11_DEFVAL                            (0x0202)
/** Default value for element 12 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC12_DEFVAL                            (0x0200)
/** Default value for element 12 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC13_DEFVAL                            (0x0700)
/** Default value for element 14 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC14_DEFVAL (0x8100 | CSL_MSC_ENDPOINT_DESCRIPTOR_TYPE)
/** Default value for element 15 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC15_DEFVAL                            (0x0002)
/** Default value for element 16 in dummy descriptor array                   */
#define CSL_MSC_DUMMY_DESC16_DEFVAL                            (0x0002)
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  MSC_Open function should be called successfully
 *
 *   <b> Post Condition </b>
