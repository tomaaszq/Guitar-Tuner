...
/** @file csl_mscAux.h
 *
 *  @brief USB MSC functional layer Auxilliary header file
 *
 *  Path: \(CSLPATH)\ inc
 */
                                ...
                                Uint16           logicalUnit)
{
	...
	modeSenseLen = pMscHandle->tempBuffer[0];
 ...
 *   and returns the correspending request habdler address
 *
 *   @b Arguments
 *   @verbatim
 ...
 *
 *   <b> Pre Condition </b>
 *   @n  Request table should be initialized and MSC_Open function should be
 *       called successfully
 *
 *   <b> Post Condition </b>
 ...
 *
 *   <b> Return Value </b>
 *   @li                   CSL_MSC_REQUEST_DONE - Request hadled successfully
 *
 *   <b> Pre Condition </b>
 *   @n  MSC_lookupReqHandler should be called successfully
 *
                                   ...
                                   void                  *pMsc)
{
	...
	if(pMscClassHdl->mscHandle.noOfLun > 0)
	{
