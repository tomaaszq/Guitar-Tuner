...
#define CSL_NAND_RESET_COUNT_VAL                    (0x10)
...
#define CSL_NAND_ASYNCCFG_WSTROBE_DEFAULT           (0x3F)
 ...
 *
 *   @b Description
 *   @n This API gives the bank details of the nand device
 *
 *   @b Arguments
 *   @verbatim
            hNand      Handle to the nand object
...
CSL_Status NAND_readNBytes(CSL_NandHandle     hNand,
                           Uint16             readRequest,
                           volatile Uint16    * const pReadBuffer,
                           Uint16             pack,
                           Bool				  spare);
...
CSL_Status NAND_writeNBytes(CSL_NandHandle     hNand,
                            Uint16             writeRequest,
                            volatile Uint16    * const pWriteBuffer,
                            Uint16             val,
                            Bool			   spare);
