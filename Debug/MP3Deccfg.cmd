...
_TSK_idle = TSK_idle;
_decode = decode;
_read_samples = read_samples;
_menu_control = menu_control;
_led_blinking = led_blinking;
...
MEMORY {
   ...
   PAGE 0:     SARAM:    origin = 0x20000, len = 0x80000
   PAGE 0:     DARAM2:   origin = 0x10000, len = 0x10000
}
/* MODULE CLK */
SECTIONS {
...
SECTIONS {
        ...
        .decode$stk: block(0x20000){
            *(.decode$stk)
        } > DARAM PAGE 0

        .read_samples$stk: block(0x20000){
            *(.read_samples$stk)
        } > DARAM PAGE 0

        .led_blinking$stk: block(0x20000){
            *(.led_blinking$stk)
        } > DARAM PAGE 0
       ...
       .hst0: block(0x20000) align = 0x4 {} > DARAM PAGE 0
        ...
        .udev: block(0x20000){} > SARAM PAGE 0

        .gio: block(0x20000)    {} > SARAM PAGE 0

        .sys: block(0x20000)    {} > SARAM PAGE 0

        .devtable: block(0x20000){} > SARAM PAGE 0
       ...
       /* no HWI stubs are necessary */
        ...
        .menu_control$stk: block(0x20000){
            *(.menu_control$stk)
        } > SARAM PAGE 0
